      ...
      if (this.state.messageFromServer == '') {
          return (
              <div>
                  ...
                  <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} contentLabel="Add Expense"
                  className="Modal">
                      ...
                      <fieldset>
                          ...
                          <select id="year" name="year" value={this.state.year}
                              onChange={this.handleSelectChange}>
          ...
          return (
              <div>
                  ...
                  <Modal isOpen={this.state.modalIsOpen} onAfterOpen={this.afterOpenModal}
                      onRequestClose={this.closeModal} contentLabel="Add Expense"
                      className="Modal">
                      <div className="button-center">
